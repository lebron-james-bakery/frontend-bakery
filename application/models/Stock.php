...
class Stock extends CI_Model {
    ...
    var $data = array(
        ...
        array('id' => '3',  'name' => 'Apricot Bars', 'pic' => 'Apricot_Bars.jpg', 'where' => '/sales/3', 'price' => '$6', 'order' => '10 items',
        ...
        array('id' => '4',  'name' => 'Blueberry Lemon Coffee Cake', 'pic' => 'BG_Blueberry_Lemmon_Coffee_Cake.jpg', 'where' => '/sales/4', 'price' => '$3.75','order' => '6 items',
            'description' =>'A delicious dessert with blueberries that will entice everyone to have a bite.'),
        array('id' => '5',  'name' => 'Chocolate Brownies', 'pic' => 'Chocolate_Brownies.jpg', 'where' => '/sales/5', 'price' => '$5.15', 'order' => '5 items',
        ...
        array('id' => '6',  'name' => 'Swedish Rum Cake', 'pic' => 'Swedish_Rum_Cake.jpg', 'where' => '/sales/6', 'price' => '$6', 'order' => '6 items',
