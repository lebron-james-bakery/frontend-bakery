...
('Eggnog Pound Cake','If you do have some eggnog, here is a wonderful pound cake to make with it, a cake that celebrates all things eggnoggy (new word, just made it up). Like eggnog, it is well spiced with nutmeg, cinnamon, and allspice. It has flecks of sweetened dried cranberries and orange zest.',4.5,18,'eggnog-poundcake.jpg'),
('Banana Bread Granola','This Banana Bread Granola has all the warm comforting flavors of my favorite banana bread recipe (the one right here on Simply Recipes!), but it’s a little more suitable for weekday breakfasts.',3.75,20,'Banana-Bread-Granola.jpg'),
('Blackberry Muffins','The secret to making the best muffins is sour cream! Rich and tangy sour cream not only intensifies the flavor of the berries, but makes the muffins irresistibly tender and delicious.',4.75,17,'blackberry-muffins.jpg'),
('Perfect Cheesecake','It is a classic New York style cheesecake with a graham cracker crust and high sides. It is dense, rich, and light at the same time, and serves a small army. But watch out—just when you think you’ve made enough for your gathering, so many people will go back for seconds that you may be left without a piece!',3.75, 12,'perfect-cheesecake.jpg');
